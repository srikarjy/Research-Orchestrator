...
type AletheiaGatewayService interface {
	Investigate(ctx context.Context, query string, options map[string]interface{}) (*InvestigationResponse, error)
	GetInvestigationStatus(ctx context.Context, workflowID string) (*InvestigationStatus, error)
